...
// line 111 "../../../../../TileO(updatedMar22).ump"
public class Player implements Serializable
{
  ...
  public boolean loseTurns(int n)
  {
    ...
    switch (aPlayerStatus)
    {
      case Active:
        if (n>0)
        {
        // line 119 "../../../../../TileO(updatedMar22).ump"
      ...
      case Inactive:
        if (n>0)
        {
        // line 130 "../../../../../TileO(updatedMar22).ump"
          setTurnsUntilActive(getTurnsUntilActive() + n);
          setPlayerStatus(PlayerStatus.Inactive);
          wasEventProcessed = true;
          break;
  ...
  public boolean takeTurn()
  {
    ...
    switch (aPlayerStatus)
    {
      case Inactive:
        ...
        {
        // line 124 "../../../../../TileO(updatedMar22).ump"
        ...
        if (getTurnsUntilActive()<=1)
        {
        // line 127 "../../../../../TileO(updatedMar22).ump"
  ...
  // line 138 "../../../../../TileO(updatedMar22).ump"
