...
public class DeckPanel extends JPanel {
	...
	public void setCardInfo(ActionCard card) {
		...
		/*
		 * else if(card instanceof ChooseAdditionalMoveActionCard){ titleText =
		 * "Choose Additional Move Action Card"; descriptionTest =
		 * "Choose the number of tiles that you want to move."; }
		 */
		refresh();
	}
